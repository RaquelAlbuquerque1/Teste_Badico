# DESCRIÇÃO
  ...
  Este repositório refere-se a uma página de inserção de multiplos emails para testá-lo siga as intruções de clones abaixo ou faça o download do zip,extraia na sua máquina  e execute o arquivo index.html, ou acesse [aqui](https://raquelalbuquerque1.github.io/teste-badico/src/).
